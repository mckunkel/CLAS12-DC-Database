...
import database.objects.dc.TBHits;
import database.util.Coordinate;
import database.util.DataPointMultiDimension;
import database.util.DataPoints;
import database.util.DataPoints2;
import dataframe.spark.EmptyDCFrame;
import dataframe.spark.SparkConnection;

public class DataProcess implements IDataEventListener {
