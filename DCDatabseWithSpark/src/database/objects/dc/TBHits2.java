...
public class TBHits2 {
	...
	// public TBHits(int id, int status, int sector, int superLayer, int layer,
	// int wire, float time, float doca,
	// float docaError, float trkDoca, float timeResidual, int lR, float x,
	// float z, float b, int clusterID,
	// int trkID) {
	// this.id = id;
	// this.status = status;
	// this.sector = sector;
	...
	public TBHits2(int trkID, int status) {
		this.status = status;
